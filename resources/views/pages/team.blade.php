...
<head>
    ...
    <title> Team Details || zeena || HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="team-details">
            <div class="team-details__shape-1 float-bob-y">
                <img src="{{asset('frontend/images/shapes/team-details-shape-1.png')}}" alt="">
            </div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="team-details__left">
                            <div class="team-details__img">
                                ...
                                <div class="team-details__social-box">
                                    <ul class="list-unstyled team-details__social">
                                        <li><a href="{{url($team->facebook_link)}}"><i class="fab fa-facebook-f"></i></a></li>
                                        ...
                                        <li><a href="{{url($team->linkedin_link)}}"><i class="fab fa-linkedin-in"></i></a></li>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="team-details__right">
                            <h3 class="team-details__title">Mamber Information</h3>
                            <p class="team-details__text">{{$team->mamber_info}}</p>
                            <ul class="team-details__points list-unstyled">
                                ...
                                <Li>
                                    ...
                                    <div class="text">
                                        <p>{{$team->mamber_keyword_2}}</p>
                                    </div>
                                </Li>
                            </ul>
                            <div class="team-details__points-box">
                                <ul class="team-details__points-2 list-unstyled">
                                    <li>
                                        <h4>Phone : </h4>
                                        <p><a href="tel:{{$team->mamber_phone}}">{{$team->mamber_phone}}</a></p>
                                    </li>
                                    <li>
                                        <h4>Email : </h4>
                                        <p><a href="mailto:{{$team->mamber_email}}">{{$team->mamber_email}}</a></p>
                                    </li>
                                    <li>
                                        <h4>Website : </h4>
                                        <p><a href="{{$team->mamber_website}}">{{$team->name}}.com</a></p>
                                    </li>
            ...
            <div class="container">
                <div class="qualification__inner">
                    <div class="qualification__left">
                        <h3 class="qualification__left-title">Qualifications:</h3>
                        <p class="qualification__left-text">Education/Certification:</p>
                        <p class="qualification__left-text-2">{{$team->education_qualification}}</p>
                        
                    </div>
                    <div class="qualification__right">
                        <h3 class="qualification__right-title">Skills/Abilities:</h3>
                        <ul class="qualification__points list-unstyled">
                            <li>
                                <div class="icon">
                                    <span class="fa fa-check"></span>
                                </div>
                                <div class="text">
                                <label for="file" style="color: black; padding-right: 10px;">{{ $team->technology_skill_1}}</label>
                                <progress id="file" value="{{ $team->technology_skill_parcent_1}}" max="100" style="color: black;"> {{ $team->technology_skill_parcent_1}}%</progress>
                            ...
                            <li>
                                ...
                                <div class="text">
                                <label for="file" style="color: black; padding-right: 10px;">{{ $team->technology_skill_2}}</label>
                                <progress id="file" value="{{ $team->technology_skill_parcent_2}}" max="100" style="color: black; padding-left: 10px;"> {{ $team->technology_skill_parcent_2}}%</progress>
                            ...
                            <li>
                                ...
                                <div class="text">
                                <label for="file" style="color: black; padding-right: 10px;">{{ $team->technology_skill_3}}</label>
                                <progress id="file" value="{{ $team->technology_skill_parcent_3}}" max="100" style="color: black; padding-left: 10px;"> {{ $team->technology_skill_parcent_3}}%</progress>
                            ...
                            <li>
                                ...
                                <div class="text">
                                <label for="file" style="color: black; padding-right: 10px;">{{ $team->technology_skill_4}}</label>
                                <progress id="file" value="{{ $team->technology_skill_parcent_4}}" max="100" style="color: black; padding-left: 10px;"> {{ $team->technology_skill_parcent_4}}%</progress>
